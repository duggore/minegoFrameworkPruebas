  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <a href="agrega.php">
            <img class="img-circle" src="../../../img/96/Package-add.png" data-src="../../../img/96/Package-add.png" alt="Generic placeholder image">
          </a>
        ...
        <div class="col-lg-4">
          <a href="elimina.php">
            <img class="img-circle" src="../../../img/96/Item-configuration.png" data-src="../../../img/96/Item-configuration.png" alt="Generic placeholder image">
          </a>
        ...
        <div class="col-lg-4">
          <a href="elimina.php">
            <img class="img-circle" src="../../../img/96/Package-delete.png" data-src="../../../img/96/Package-delete.png" alt="Generic placeholder image">
          </a>
