    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <h2>Inventario</h2>
          <p><a class="btn btn-primary" href="inventario/index.php">Entrar &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-success" href="caja/index.php">Entrar &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <a href="corteCaja/index.php">
            <img class="img-circle" src="../../img/96/wallet.png" data-src="../../img/96/wallet.png" alt="Generic placeholder image">
          </a>
          <h2>Corte de caja</h2>
          <p><a class="btn btn-warning" href="corteCaja/index.php">Entrar &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
    </div>
