  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <a href="agrega.php">
            <img class="img-circle" src="../../../img/96/eterprise-add.png" data-src="../../../img/96/eterprise-add.png" alt="Generic placeholder image">
          </a>
        ...
        <div class="col-lg-4">
          <a href="agrega.php">
            <img class="img-circle" src="../../../img/96/enterprise-update.png" data-src="../../../img/96/enterprise-update.png" alt="Generic placeholder image">
          </a>
          <h2>Actualizar Sucursales</h2>
          <p><a class="btn btn-success" href="agrega.php">Entrar &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <a href="agrega.php">
            <img class="img-circle" src="../../../img/96/enterprise-delete.png" data-src="../../../img/96/enterprise-delet.png" alt="Generic placeholder image">
          </a>
          <h2>Eliminar Sucursal</h2>
          <p><a class="btn btn-warning" href="agrega.php">Entrar &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
    </div>
    <div class="container">
