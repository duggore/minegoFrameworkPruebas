...
$rfEmpresaActualizar = $_POST["rfcEmpresa"];
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="funciones/appActualizaEmpresa.php" method="post">
        <div class="col-md-12">
              ...
              <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                  <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control" name="rfcNegoAdd" placeholder="RFC Empresa" value="<?php echo $rfEmpresaActualizar;?>" required>
                    <input type="number" name="idUsuario" value="<?php echo $idUsr; ?>" hidden>
                  </div>
                  <div class="col-lg-8">
                    <label>Nombre Nego Nuevo o Sucursal:</label>
                    <input type="text" class="form-control" name="nombreNego" placeholder="Nombre de la nueva sucursal o negocio a Cargo" value="<?php echo devNombreEmpresa($rfEmpresaActualizar); ?>" required>
                  </div>
                  <div class="col-lg-4">
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseTwo" class="panel-collapse collapse in">
                <div class="panel-body">
                  ...
                  <div class="col-lg-8">
                    <label>Calle:</label>
                    <input type="text" class="form-control" placeholder="Calle, Avenida, Carretera..." name="calle" value="<?php echo devCalleEmpresa($rfEmpresaActualizar); ?>" required>
                  </div>
                  <div class="col-lg-4">
                    <label>Numero Exterior:</label>
                    <input type="number" class="form-control" placeholder="Numero exterior" min="1" name="noEx" value="<?php echo devNumExtEmpresa($rfEmpresaActualizar); ?>" required>
                  </div>
                  <div class="col-lg-4">
                    <label>Numero Interior:</label>
                    <input type="number" class="form-control" placeholder="Numero interior" min="0" name="noIn" value="<?php echo devNumIntEmpresa($rfEmpresaActualizar); ?>" required>
                  </div>
                  <div class="col-lg-4">
                    <label>Codigo Postal:</label>
                    <input type="number" class="form-control" placeholder="Codigo Postal" name="cp" value="<?php echo devCpEmpresa($rfEmpresaActualizar); ?>" required>
                  </div>
                  <div class="col-lg-4">
                    <label>Telefono Fijo:</label>
                    <input type="tel" class="form-control" placeholder="10 Digitos" name="tf" value="<?php echo devTelFijoEmpresa($rfEmpresaActualizar); ?>" required>
                  </div>
                  <div class="col-lg-12">
                    <label>Descripción:</label>
                    <textarea class="form-control" name="desc" value="<?php echo devDescripcionEmpresa($rfEmpresaActualizar); ?>" required></textarea>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="panel panel-group panel-success">
            <div class="panel-heading">Para finalizar <img align="right" src="">
              ...
              <div class="panel-body" align="center">
                ...
                <div class="col-md-6">
                  <button class="btn btn-success btn-lg" type="submit" name="Submit">Actualizar</button>
                  <br>
                </div>
              </div>
          </div>
                ...
                <div class="col-md-12 table-responsive" style="overflow : auto;">
                  <table class="table table-striped">
                    ...
                    <?php
                      ...
                      function devNombreEmpresa($id)
                      {
                        $sql = mysql_query("SELECT nombre_empresa FROM tbl_empresa WHERE rfcEmpresa = '$id'")or die(mysql_error());
                        while ($dts = mysql_fetch_row($sql)) 
                        {
                          return $dts[0];
                        }
                      ...
                      function devCalleEmpresa($id)
                      {
                        $sql = mysql_query("SELECT calle FROM tbl_empresa WHERE rfcEmpresa = '$id'")or die(mysql_error());
                        while ($dts = mysql_fetch_row($sql)) 
                        {
                          return $dts[0];
                        }
                      ...
                      function devNumExtEmpresa($id)
                      {
                        $sql = mysql_query("SELECT numero_exterior FROM tbl_empresa WHERE rfcEmpresa = '$id'")or die(mysql_error());
                        while ($dts = mysql_fetch_row($sql)) 
                        {
                          return $dts[0];
                        }
                      ...
                      function devNumIntEmpresa($id)
                      {
                        $sql = mysql_query("SELECT numero_interior FROM tbl_empresa WHERE rfcEmpresa = '$id'")or die(mysql_error());
                        while ($dts = mysql_fetch_row($sql)) 
                        {
                          return $dts[0];
                        }
                      ...
                      function devCpEmpresa($id)
                      {
                        $sql = mysql_query("SELECT codigo_postal FROM tbl_empresa WHERE rfcEmpresa = '$id'")or die(mysql_error());
                        while ($dts = mysql_fetch_row($sql)) 
                        {
                          return $dts[0];
                        }
                      ...
                      function devTelFijoEmpresa($id)
                      {
                        $sql = mysql_query("SELECT telefono_fijo FROM tbl_empresa WHERE rfcEmpresa = '$id'")or die(mysql_error());
                        while ($dts = mysql_fetch_row($sql)) 
                        {
                          return $dts[0];
                        }
                      ...
                      function devDescripcionEmpresa($id)
                      {
                        $sql = mysql_query("SELECT descripcion FROM tbl_empresa WHERE rfcEmpresa = '$id'")or die(mysql_error());
                        while ($dts = mysql_fetch_row($sql)) 
                        {
                          return $dts[0];
                        }
