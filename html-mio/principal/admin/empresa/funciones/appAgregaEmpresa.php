...
if ($objEmpresa->agregaEmpresaSucursal($rfcEmpresa, $nombre_empresa, $id_giro, $id_razon_social, $id_tipo_empresa, $id_estado, $id_municipio, $id_localidad,
		$calle, $numero_exterior, $numero_interior, $codigo_postal, $telefono_fijo, $descripcion, devIdEmpleado($idUsr)) == true) 
{
	header("Location: ../agrega.php?error_login=<div class='alert alert-success'>Empresa o Sucursal agregada con éxito</div>");
    exit;
}
else
{
